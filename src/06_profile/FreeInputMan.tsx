  ...
  return (
    ...
    <NomalHeader />
      <div className="Min390Max">
        ...
        {/* 태어난 시간 */}
        <div className="input-wrap-small mt-52">
          ...
          <div className="d-flex align-items-center justify-content-between">
            ...
            <div className="d-flex align-items-center">
              <span className="mx-3 fs-15-gray-800">모르겠어요</span>
        ...
        <div className="input-wrap mt-52">
          <div className="">
            ...
            <div className="d-flex align-items-center justify-content-between">
              <p className="fs-15-gray-800">관계를 선택해 주세요</p>
        ...
        <div className="input-btn-wrap2">
          <a className="basicGray100" href="/paycompnone">
            다음
          </a>
          <a className="basicGray100" href="/paycomp">
            다음
          </a>
        </div>
      </div>
